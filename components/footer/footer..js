...
const Footer = () => {
    return (
        <footer className="flex flex-row border-solid border-t border-teal-500 py-5 px-5 mt-8">
            ...
            <div className="p-2 basis-2/5">
                ...
                <div className="pt-3 grid grid-cols-2 w-52">
                    <SocialIcon link="https://www.facebook.com/LogarInmobiliariazgz/" width="40" src="https://logarinmobiliaria.desarrollobirdcom.es/wp-content/uploads/2022/10/facebook-rect-1.png"/>
                    <SocialIcon link="https://www.instagram.com/logarinmobiliaria/?hl=es" width="40"src="https://logarinmobiliaria.desarrollobirdcom.es/wp-content/uploads/2022/10/instagram-1.png"/>
                </div>
            </div>
